...
\begin{figure}[H]
    ...
    \caption{Esquema del problema de estudio. Se nombran a las partes para referenciarlas fácilmente: los átomos los llamamos A y B, y la cavidad la llamaremos C, esta puede contener una cantidad arbitraria de excitaciones, pero nos concentraremos principalmente en 0,1 y 2 excitaciones. Ambos átomos son de dos niveles, son idénticos e indistinguibles y su frecuencia natural es $\omega$, mientras que la frecuencia natural de la cavidad es $\omega_0$. El acoplamiento entre la cavidad y el atomo es $g$, y las interacciones atomo-atomo son $k$ (interaccion dipolar) y $J$ (interaccion tipo Ising).}
...
\begin{figure}[H]
    ...
    \begin{minipage}[c]{0.3\textwidth}
        \caption{Trayectorias sobre la esfera de Bloch cuya condicion inicial es $\ket{e_Ag_b0_C}$ para diferentes valores del detunning, apantallando el atomo B. Los valores son $\Delta=0$ (azul), $\Delta=0.5g$ (morada) y $\Delta=2g$ (naranja).}
...
\begin{figure}[H]
    ...
    \end{minipage}\hfill
    \begin{minipage}[c]{0.3\textwidth}
        \caption{Trayectorias sobre la esfera de Bloch cuya condicion inicial es $(\ket{e_Ag_b0_C}+\ket{g_Ae_b0_C})/\sqrt{2}$ para diferentes valores del detunning, apantallando el atomo B. Los valores son $\Delta=0$ (azul), $\Delta=0.5g$ (morada) y $\Delta=2g$ (naranja).}
    \end{minipage}
    \label{fig4:bloch delta}
\end{figure}
