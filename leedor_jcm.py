...
evals_death_t=np.loadtxt(f'datajcm/drive-download-20251118/evalst death x{x/g} ga{gamma/g} p{p/gamma:.1f}.txt')
fg_u_delta=np.loadtxt(f'datajcm/drive-download-20251118/fgu x{x/g} ga{gamma/g} p{p/gamma:.1f}.txt')
fg_d_delta=np.loadtxt(f'datajcm/drive-download-20251118/fgd x{x/g} ga{gamma/g} p{p/gamma:.1f}.txt')
Nu_delta=np.loadtxt(f'datajcm/drive-download-20251118/Nu x{x/g} ga{gamma/g} p{p/gamma:.1f}.txt')
Nd_delta=np.loadtxt(f'datajcm/drive-download-20251118/Nd x{x/g} ga{gamma/g} p{p/gamma:.1f}.txt')
